...
Gem::Specification.new do |spec|
  spec.name          = "certify_email"
  spec.version       = CertifyEmail::VERSION::STRING
  spec.authors       = ["Fearless"]
  spec.email         = [""]

  spec.summary       = "Ruby Gem to wrap the Email API"
  spec.description   = "Ruby Gem to wrap the Email API (GIT_DESCRIBE)"
  spec.homepage      = "https://github.com/USSBA/certify_email.git"
  spec.license       = "MIT"
